...
MODEL_PATH = "neKabuz/f07Model.h5"
...
# f03 fitxategian saiakera bat itet, saiakera "guarro" bat if batzukin.
# Fitxategi hontan saiakera hoi hobetukot
# Ideia, benetazko entornotik kampoko laguntza bat ematea da.
def potential(state):
    return 10.0 * state[0]
...
for episode in range(EPISODES):
    ...
    for step in range(STEPS_PER_EPISODE - 1):
        ...
        reward += discount_factor * potential(next_state) - potential(current_state) # Reward shaping
